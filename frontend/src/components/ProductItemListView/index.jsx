    ...
    <div className='productItem rounded-md shadow-lg overflow-hidden border-1 border-[rgba(0,0,0,0.1)] flex items-center'>
        <div className='group imgWrapper w-[25%] overflow-hidden rounded-md relative'>
            ...
            <div className='info p-3 py-5 px-8 w-[75%]'>
                ...
                <h3 className='text-[18px] title mt-3 mb-3 font-[500] link transition-all'>
                <Link to='/' className='link'>
                  Women Wide Leg High-Rise ...
                </Link>
                  
                </h3>
                <p className='text-[14px] mb-2'>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.</p>
                ...
                <Button className='btn-org !text-white gap-2'><MdOutlineShoppingCart className='text-[16px]'/>
                    Add to Cart
                  </Button>
            </div>
    </div>
