...
function createData(id, image) {
  return { id, image };
}

const rows = [
  createData(1,"https://serviceapi.spicezgold.com/download/1755503364377_1721277298204_banner.jpg"),
  createData(2, "/logo.jpg"),
  createData(3, "/banner3.jpg"),
  createData(4, "/banner4.jpg"),
];

const TableHomeSliderBanners = () => {
...
export default TableHomeSliderBanners;
