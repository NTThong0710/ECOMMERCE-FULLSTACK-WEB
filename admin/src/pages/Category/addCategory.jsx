        ...
        <div className='form grid grid-cols-1'>
            <div className='pr-4 pt-8 pb-8'>
                <div className='col pb-8'>
                    <h3 className='text-[14px] font-[500] mb-3 text-black'>Category Name</h3>
                    <input type="text" className='h-[40px] border border-[rgba(0,0,0,0.2)] bg-[] w-[25%] focus:outline-none 
